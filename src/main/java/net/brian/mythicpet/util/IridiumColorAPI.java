...
import net.brian.mythicpet.util.pattern.GradientPattern;
import net.brian.mythicpet.util.pattern.Pattern;
import net.brian.mythicpet.util.pattern.RainbowPattern;
import net.brian.mythicpet.util.pattern.SolidPattern;
